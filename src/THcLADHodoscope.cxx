...
Int_t THcLADHodoscope::DefineVariables(EMode mode) {
  ...
  RVarDef vars[] = {
      ...
      {"goodhit_chiSquare_1D_xz_GEM0", "1D projective x-z chi-square, target+hodo+front GEM (-1=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrkChiSqr_1D_xz_GEM0()"},
      {"goodhit_chiSquare_1D_xz_GEM1", "1D projective x-z chi-square, target+hodo+back GEM (-1=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrkChiSqr_1D_xz_GEM1()"},
      {"goodhit_chiSquare_1D_xz_GEMboth", "1D projective x-z chi-square, target+hodo+both GEMs (-1=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrkChiSqr_1D_xz_GEMboth()"},
      {"goodhit_chiSquare_1D_y_GEM0", "1D projective y chi-square, target+hodo+front GEM (-1=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrkChiSqr_1D_y_GEM0()"},
      {"goodhit_chiSquare_1D_y_GEM1", "1D projective y chi-square, target+hodo+back GEM (-1=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrkChiSqr_1D_y_GEM1()"},
      {"goodhit_chiSquare_1D_y_GEMboth", "1D projective y chi-square, target+hodo+both GEMs (-1=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrkChiSqr_1D_y_GEMboth()"},
      {"goodhit_chiSquare_1D_GEM0", "1D projective combined (xz+y) chi-square, front GEM (-1=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrkChiSqr_1D_GEM0()"},
      {"goodhit_chiSquare_1D_GEM1", "1D projective combined (xz+y) chi-square, back GEM (-1=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrkChiSqr_1D_GEM1()"},
      {"goodhit_chiSquare_1D_GEMboth", "1D projective combined (xz+y) chi-square, both GEMs (-1=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrkChiSqr_1D_GEMboth()"},
      // Degrees of freedom of each track chi-square above (residual terms - fit
      // params; -1 = not computed). Divide chiSquare by this for a reduced chi2.
      {"goodhit_chiSquare_ndof", "Good hit chi-square dof", "fGoodLADHits.THcGoodLADHit.GetTrkNdof()"},
      {"goodhit_chiSquare_noTrackVertex_ndof", "Good hit chi-square dof (no vertex)",
       "fGoodLADHits.THcGoodLADHit.GetTrkNdof_noTrackVertex()"},
      {"goodhit_chiSquare_xz_ndof", "Good hit chi-square dof (x-z fit)",
       "fGoodLADHits.THcGoodLADHit.GetTrkNdof_xz()"},
      {"goodhit_chiSquare_noTrackVertex_xz_ndof", "Good hit chi-square dof (no vertex, x-z fit)",
       "fGoodLADHits.THcGoodLADHit.GetTrkNdof_noTrackVertex_xz()"},
      {"goodhit_chiSquare_1D_xz_GEM0_ndof", "1D projective x-z chi-square dof, front GEM (-1=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrkNdof_1D_xz_GEM0()"},
      {"goodhit_chiSquare_1D_xz_GEM1_ndof", "1D projective x-z chi-square dof, back GEM (-1=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrkNdof_1D_xz_GEM1()"},
      {"goodhit_chiSquare_1D_xz_GEMboth_ndof", "1D projective x-z chi-square dof, both GEMs (-1=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrkNdof_1D_xz_GEMboth()"},
      {"goodhit_chiSquare_1D_y_GEM0_ndof", "1D projective y chi-square dof, front GEM (-1=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrkNdof_1D_y_GEM0()"},
      {"goodhit_chiSquare_1D_y_GEM1_ndof", "1D projective y chi-square dof, back GEM (-1=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrkNdof_1D_y_GEM1()"},
      {"goodhit_chiSquare_1D_y_GEMboth_ndof", "1D projective y chi-square dof, both GEMs (-1=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrkNdof_1D_y_GEMboth()"},
      {"goodhit_chiSquare_1D_GEM0_ndof", "1D projective combined (xz+y) chi-square dof, front GEM (-1=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrkNdof_1D_GEM0()"},
      {"goodhit_chiSquare_1D_GEM1_ndof", "1D projective combined (xz+y) chi-square dof, back GEM (-1=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrkNdof_1D_GEM1()"},
      {"goodhit_chiSquare_1D_GEMboth_ndof", "1D projective combined (xz+y) chi-square dof, both GEMs (-1=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrkNdof_1D_GEMboth()"},
      {"goodhit_trk1D_x0", "1D-track winning-cluster lab x on GEM0 (front) (-1000=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrk1DX0()"},
      {"goodhit_trk1D_y0", "1D-track winning-cluster lab y on GEM0 (front) (-1000=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrk1DY0()"},
      {"goodhit_trk1D_x1", "1D-track winning-cluster lab x on GEM1 (back) (-1000=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrk1DX1()"},
      {"goodhit_trk1D_y1", "1D-track winning-cluster lab y on GEM1 (back) (-1000=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrk1DY1()"},
      {"goodhit_trk1D_adcx0", "1D-track winning V/x-z cluster ADC sum on GEM0 (front) (-1000=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrk1DAdcX0()"},
      {"goodhit_trk1D_adcy0", "1D-track winning U/y cluster ADC sum on GEM0 (front) (-1000=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrk1DAdcY0()"},
      {"goodhit_trk1D_adcx1", "1D-track winning V/x-z cluster ADC sum on GEM1 (back) (-1000=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrk1DAdcX1()"},
      {"goodhit_trk1D_adcy1", "1D-track winning U/y cluster ADC sum on GEM1 (back) (-1000=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrk1DAdcY1()"},
