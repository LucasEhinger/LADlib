...
Int_t THcLADHodoscope::DefineVariables(EMode mode) {
  ...
  RVarDef vars[] = {
      ...
      {"goodhit_trk1D_clidx_x0", "1D-track winning V/x-z cluster CLIndex on GEM0 (front); index into clust.* (-1=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrk1DClIdxX0()"},
      {"goodhit_trk1D_clidx_x1", "1D-track winning V/x-z cluster CLIndex on GEM1 (back); index into clust.* (-1=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrk1DClIdxX1()"},
      {"goodhit_trk1D_clidx_y0", "1D-track winning U/y cluster CLIndex on GEM0 (front); index into clust.* (-1=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrk1DClIdxY0()"},
      {"goodhit_trk1D_clidx_y1", "1D-track winning U/y cluster CLIndex on GEM1 (back); index into clust.* (-1=none)",
       "fGoodLADHits.THcGoodLADHit.GetTrk1DClIdxY1()"},
