...
Int_t THcLADHodoscope::DefineVariables(EMode mode) {
  ...
  RVarDef vars[] = {
      ...
      {"goodhit_trackid_1D", "Good hit trk1d candidate row (1D-cluster tracking)",
       "fGoodLADHits.THcGoodLADHit.GetTrackID_1D()"},
      {"goodhit_chiSquare_1D", "Good hit chi-square (1D-cluster tracking, total)",
       "fGoodLADHits.THcGoodLADHit.GetTrkChiSqr_1D()"},
      {"goodhit_chiSquare_1D_xz", "Good hit chi-square (1D-cluster tracking, horizontal x-z part)",
       "fGoodLADHits.THcGoodLADHit.GetTrkChiSqr_1D_xz()"},
      {"goodhit_chiSquare_1D_y", "Good hit chi-square (1D-cluster tracking, vertical y part)",
       "fGoodLADHits.THcGoodLADHit.GetTrkChiSqr_1D_y()"},
